...
- Once you click Get Started With Azure you will be prompted to select either (Try Azure For Free) or (Pay As You Go Option). 
- Read over the account that's right for you and select it to continue. 
</p>
<br />
